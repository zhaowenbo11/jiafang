...
const roomTone = {
  wedding: {
    ...
    curtain: "linear-gradient(180deg, rgba(255,255,255,0.34), rgba(214,164,145,0.1))",
    decor: "婚房陈列",
  ...
  custom: {
    ...
    curtain: "linear-gradient(180deg, rgba(255,255,255,0.28), rgba(227,197,172,0.08))",
    decor: "高定陈列",
  ...
  kids: {
    ...
    curtain: "linear-gradient(180deg, rgba(255,255,255,0.3), rgba(210,232,241,0.08))",
    decor: "儿童房陈列",
        ...
        <div className="flex min-h-[420px] flex-col rounded-[24px] border border-white/25 bg-[linear-gradient(160deg,rgba(255,255,255,0.18),rgba(255,255,255,0.04))] p-5">
          ...
          <div className="mt-4 grid gap-4">
            <div className="relative overflow-hidden rounded-[28px] border border-white/18 bg-[rgba(255,255,255,0.08)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_18px_40px_rgba(48,22,18,0.14)]">
              <div className="absolute inset-x-0 top-0 h-[70%]" style={{ background: activeRoomTone.wall }} />
              <div className="absolute inset-x-0 bottom-0 h-[34%]" style={{ background: activeRoomTone.floor }} />
              ...
              <div className="relative flex h-[260px] items-end justify-center sm:h-[292px]">
                ...
                <div className="absolute inset-x-[18%] bottom-[16%] h-10 rounded-[24px] bg-[var(--vignette)] blur-2xl" style={{ ["--vignette" as never]: activeRoomTone.vignette }} />
                ...
                >
                  ...
                  <div className="relative mx-auto -mt-1 h-[180px] overflow-hidden rounded-[34px] border border-white/14 bg-[rgba(255,255,255,0.08)] px-5 pt-5 shadow-[0_28px_54px_rgba(54,28,20,0.24)] sm:h-[198px]">
                    ...
                    <div
                      ...
                      style={surfaceStyle}
                    >
                      <div className="absolute inset-0 opacity-80" style={{ backgroundImage: fabricTextureMap[selectedFabric.pattern], backgroundSize: getPatternSize(selectedFabric.pattern) }} />
            ...
            <div className="flex items-center justify-between rounded-[22px] border border-white/16 bg-[rgba(255,255,255,0.1)] px-4 py-3 backdrop-blur-sm">
              <div>
                ...
                <p className="mt-1 text-base font-semibold text-white">
                  {isDetail ? "面料细节层" : isScene ? "场景搭配层" : "主成品层"}
                </p>
              </div>
